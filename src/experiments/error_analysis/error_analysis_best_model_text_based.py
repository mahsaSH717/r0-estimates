...
model_is_from = "squad_v2_7"
desired_checkpoint = "checkpoint-743"
path_prefix = "../../../.."
...
output_dir = f"{path_prefix}/general_logs/err_analysis/text_based/{model_is_from}"
result_path = f"{path_prefix}/experimental_results/flan_t5_finetune_err_analysis/text_based/{model_is_from}/{desired_checkpoint}"
prediction_result_path = f"{path_prefix}/experimental_results/flan_t5_finetune_err_analysis/text_based/{model_is_from}/{desired_checkpoint}/predictions"

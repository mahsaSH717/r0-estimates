...
def meets_best_criteria(data):
    filtered_data = [item for item in data if
                     item["metrics"].get("partial_f1s_overall", 0) >= 52
...
directory_path = "../../../experimental_results/single_templates_flan_t5_fine_tuning/json_based"
...
output_file_path = "../../../experimental_results/setup_related/json_based_best_file_paths.txt"

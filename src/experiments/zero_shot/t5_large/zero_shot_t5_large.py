...
text_result_path = f"{path_prefix}/experimental_results/zero_shot/t5_large/t5_large_zero_shot_text_based_results.json"
json_result_path = f"{path_prefix}/experimental_results/zero_shot/t5_large/t5_large_zero_shot_json_based_results.json"
prediction_result_path = f"{path_prefix}/experimental_results/zero_shot/t5_large/prediction_results"
...
def evaluate_dataset(dataset_text_based, dataset_json_based):
    ...
    for template_name, template_number, filtered_dataset in dataset_text_based_group_by_template:
        ...
        save_list_to_file(template_decoded_preds,
                          f"{prediction_result_path}/{template_name}_{template_number}_t5_large_zero_shot_prediction_results.txt")

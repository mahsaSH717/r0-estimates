...
path_prefix = "../../../.."
model_is_from_train_set = 'best_templates_dataset_random_final'
...
dataset_path = f"{path_prefix}/data/processed/final_datasets/{model_is_from_train_set}/json_based/orkg_brp_dataset"
...
def compute_metrics(eval_preds):
    ...
    result = Metrics.evaluate_property_wise_json_based(label_list=decoded_labels, prediction_list=decoded_preds)

...
def is_same_research_data(rd1, rd2):
    return fuzz.ratio(rd1['abstract'], rd2['abstract']) > 70
...
df = pd.read_excel('../../../data/raw/initial_dataset/manually_annotation_result/cord19_annotated.xlsx')
df = df.astype(object)
...
df.to_excel('../../../data/raw/initial_dataset/manually_annotation_result/cord19_annotated_semi_similar_clustered.xlsx')
